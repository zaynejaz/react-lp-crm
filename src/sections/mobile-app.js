      ...
      <Container>
        <Box sx={styles.grid}>
          ...
          <Box>
            <SectionHeading
              sx={styles.heading}
              title="See what you need from CRM, now on your phone."
              description="What if you could manage your business from your phone? With the CRM mobile app, you can easily review your email reports, track customer activity, and manage your customer data — where you want it, when you need it."
            />
