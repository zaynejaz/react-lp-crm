    ...
    <section id="home" sx={styles.section}>
      <Container sx={styles.container}>
        <div sx={styles.content}>
          <Heading as="h1">
            <span>Don't just email</span>
            <br/>
            Drive growth with customer experience automation
          </Heading>
          <Text as="p">CRM gives you the email marketing, marketing automation, and client management tools you need to create incredible customer experiences.</Text>
          <Flex sx={styles.buttonGroup}>
            ...
            <Button
              ...
              onClick={handleClick}
            >
              Discover More <Play fill="#5567FF" />
            </Button>
            <ModalVideo
              channel="youtube"
              isOpen={videoOpen}
...
const styles = {
  ...
  btnPrimary: {},
  btnOutlined: {
    borderColor: rgba(85, 103, 255, 0.25),
    color: 'white',
    ml: 3,
    ':hover': {
      borderColor: rgba(85, 103, 255, 15),
      color: 'white',
