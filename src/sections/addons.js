      ...
      <Container>
        <Box sx={styles.grid}>
          <SectionHeading
            ...
            description="Make it easy to run your marketing. Set up a welcome series with email automation, segment your contacts, or use simple workflows to automate the marketing no one has time for. "
            learnMore="POWERFUL MARKETING AUTOMATION"
          />
